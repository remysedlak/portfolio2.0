  ...
  return (
    <BrowserRouter>
      ...
      <div className="h-screen flex flex-col">
        {/* Navbar */}
        <nav className="overflow-hidden overflow-y-hidden h-52 p-4 bg-red-800 text-white flex items-center justify-between sticky top-0 z-50">
          <button
        ...
        <div className=" overflow-y-auto bg-orange-100" id="home">
          <Routes>
            <Route
              path="/"
              element={

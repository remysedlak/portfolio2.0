      ...
      <Routes>
        ...
        element={
          ...
          <section id="projects" className="py-16 px-4 max-w-4xl mx-auto ">
            <h2 className="text-3xl font-eb-garamond mb-6 text-orange-600">My Projects</h2>
          ...
          <section id="timeline" className="py-16 px-8 max-w-4xl mx-auto">
            <h2 className="text-3xl font-eb-garamond mb-6 text-orange-800">Timeline</h2>
            {/* Vertical timeline line */}
    <div className="relative">
      <div className="absolute  top-0 bottom-0 w-[1px] bg-orange-500 rounded"></div>
     
    <ul className="flex flex-col gap-10">
      {timeline.map((entry, idx) => (
      <li key={idx} className="relative flex items-start ">
        {/* Dot */}
        <span className="absolute -left-1.75 mt-2 w-4 h-4 bg-orange-100 rounded-full border-2 border-orange-500 shadow"></span>
        <div className="ml-6 bg-white rounded-lg p-4 shadow-md">
        <div className="flex items-baseline gap-4 border-b ">
          <span className="text-lg font-semibold text-orange-400">{entry.year}</span>
        ...
        />
          ...
          {/* Links Section */}
          <section id="links" className="py-16 px-4 bg-yellow-100">
            <div className="md:ml-32 ml-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
              <h2 className="text-3xl font-eb-garamond mb-6 text-orange-600">Links</h2>
              ...
              <div className="hidden  mt-8 md:mt-0 md:ml-12 md:flex items-center justify-end mr-20">
              <span className="text-orange-700 font-eb-garamond text-xl flex items-center gap-2">
                <span>This website was developed by me <br/>with <img className="inline w-6 h-6 align-middle mx-1"
                  src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg" alt="TypeScript" /> TypeScript and caffiene.</span>
              </span>
              </div>
            </div>
            </div>
